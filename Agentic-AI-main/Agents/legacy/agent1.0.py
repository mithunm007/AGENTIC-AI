...
engine.setProperty('voice', voices[1].id)  # Assuming female voice at index 1
...
def handle_response_stream(response):
    ...
    for chunk in response:
        ...
        # Check if paragraph is complete (replace with your logic)
        if "." in paragraph_buffer:  # Check for two empty lines
            print(paragraph_buffer)
            speak(paragraph_buffer)  # Speak completed paragraph
